...
void OLED_Init(void)
{
    ...
    RCC_APB2PeriphClockCmd(OLED_RCC_SCL|OLED_RCC_SDA, ENABLE);	 //使能A端口时钟

    GPIO_InitStructure.GPIO_Pin = OLED_SCL_GPIO_PIN;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_OD; 		 //推挽输出
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//速度50MHz
    GPIO_Init(OLED_SCL_GPIO, &GPIO_InitStructure);	  //初始化PA0,1
...
//    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//速度50MHz
//    GPIO_Init(OLED_RES_GPIO, &GPIO_InitStructure);	  //初始化PA2
