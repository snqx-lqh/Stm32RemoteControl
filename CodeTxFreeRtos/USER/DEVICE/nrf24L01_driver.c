...
static struct nrf24L01_operations *p_nrf24L01_operations;

void nrf24L01_operation_register(struct nrf24L01_operations *nrf24L01_oper)
{
	p_nrf24L01_operations = nrf24L01_oper;
}
...
uint8_t NRF24L01_TxPacket(uint8_t *txbuf)
{
    ...
    while((p_nrf24L01_operations->read_irq_data)!=0);//等待发送完成
...
{
    uint8_t i;
    NRF24L01_Write_Buf(NRF_WRITE_REG+TX_ADDR,nrf24L01_check_buf,5);//写入5个字节的地址.
    NRF24L01_Read_Buf(TX_ADDR,nrf24L01_check_buf,5); //读出写入的地址
    for(i=0; i<5; i++)
